...
MSX_GRPATR  	equ	$53CD
MSX_GRPPAT  	equ	$53CF
MSX_CLIKSW	equ	$53DB	; Keyboard click sound
MSX_FORCLR	equ	$53E9	; Foreground colour
MSX_BAKCLR	equ	$53EA	; Background colour
MSX_BDRCLR	equ	$53EB	; Border colour
MSX_RG0SAV	equ	$53DF 	; 	Mirror of VDP register 0 (Basic: VDP(0))
MSX_RG1SAV	equ	$53E0 	; 	Mirror of VDP register 1 (Basic: VDP(1))
MSX_RG2SAV	equ	$53E1 	; 	Mirror of VDP register 2 (Basic: VDP(2))
MSX_RG3SAV	equ	$53E2 	; 	Mirror of VDP register 3 (Basic: VDP(3))
MSX_RG4SAV	equ	$53E3 	; 	Mirror of VDP register 4 (Basic: VDP(4))
MSX_RG5SAV	equ	$53E4 	; 	Mirror of VDP register 5 (Basic: VDP(5))
MSX_RG6SAV	equ	$53E5 	; 	Mirror of VDP register 6 (Basic: VDP(6))
MSX_RG7SAV	equ	$53E6 	; Mirror of VDP register 7 (Basic: VDP(7))
MSX_RG8SAV	equ	$5FE7	; Mirror of VDP register 9 (Basic: VDP(9))
MSX_RG9SAV	equ	$5FE8	; Mirror of VDP register 9 (Basic: VDP(9))
MSX_STATFL	equ	$53E7 	; 	Mirror of VDP(8) status register (S#0)
MSX_SCNCNT  	equ	$53F6
MSX_REPCNT  	equ	$53F7
MSX_FNKSTR	equ	$587F	; Ubicacion textos teclas funcion (se reaprovecha como RAM, 160 bytes)
MSX_NEWKEY	equ	$5BE5
MSX_HIMEM	equ	$5C4A	; Highest available RAM
MSX_JIFFY	equ	$5C9E
MSX_INTCNT  	equ	$5CA2
MSX_EXPTBL	equ	$5CC1	; Bios Slot / Expansion Slot	
MSX_SLTTBL	equ	$5CC5
MSX_HKEYI	equ	$5D9A	 
MSX_HTIMI   	equ	$5D9F
MSX_SSSREG	equ	$5FFF	; secondary slot select register
